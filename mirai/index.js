...
(async () => {
  ...
  const fb = chalk.hex('#00acee').underline.bold('https://fb.com/longdzzzzzzzzzz');
  ...
  console.log(chalk.hex('#ff00cc').italic('MiraiBot | LONGDZZZ | Chúc bạn một ngày chạy bot vui vẻ!'));
  console.log(chalk.hex('#FFD700')('='.repeat(50)));
